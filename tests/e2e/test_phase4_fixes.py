...
class ProvenanceFixTests(base.StateCase):
    ...
    def test_f027_coordinator_manifest_covers_provider_and_bootstrap_code(self):
        ...
        for name in (
            "src/plane_demo/provisioner.py",
            "src/plane_demo/provisioning.py",
            "src/plane_demo/providers/azure.py",
            "src/plane_demo/providers/commands.py",
            "src/plane_demo/providers/credentials.py",
            "scripts/run-certificate-job.py",
            "infra/radius/apps/child-cluster.bicep",
        ):
    ...
    def test_f027_provider_hash_mismatch_fails_even_when_api_hashes_match(self):
        ...
        kube.exec_json.return_value["files"]["src/plane_demo/providers/azure.py"] = "0" * 64
    ...
    def test_f027_replacement_data_pod_is_rehashed_before_restart_is_accepted(self):
        ...
        kube.exec_json.return_value["files"]["src/plane_demo/data_api.py"] = "0" * 64
        runner.kube = Mock(return_value=kube)
