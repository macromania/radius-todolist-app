...
SPEC = importlib.util.spec_from_file_location(
    "operator_state_exporter", Path("scripts/export-state.py")
)
...
CONTRACT = importlib.util.spec_from_file_location(
    "export_acceptance_contract", Path("scripts/fault-parent-link.py")
)
    ...
    def kubernetes(self, slot, args):
        ...
        if args[:2] == ["get", "pods"]:
            ...
            container = {
                ...
                "command": ["python", "-m", "plane_demo." + component.replace("-", "_")],
