...
from plane_demo.providers.credentials import Credentials
from plane_demo.provisioning import OperatorConfig, ProvisioningError, provision_pair
...
def main() -> int:
    ...
    try:
        ...
        if selected == "local":
            from plane_demo.providers.local import unsupported
